...
env = QuadrupedEnv(full_batch_size = FULL_BATCHSIZE, curriculum_base = CURRICULUM_BASE, mini_batch_size = MINI_BATCHSIZE)
...
savepath = "flat_velocity_MLP_noadapter.zip"
...
model = PPO('MlpPolicy', env, verbose = 1, device="cuda", learning_rate = 0.0005, policy_kwargs=policy_kwargs, batch_size = MINI_BATCHSIZE, vf_coef = 0.5, clip_range = 0.2, gae_lambda=0.95, gamma=0.998, n_steps = FULL_BATCHSIZE)#, tensorboard_log = "./ppo_laikago_flat_low_pitchRoll_reset_MLP_noadapter_tensorboard/")
